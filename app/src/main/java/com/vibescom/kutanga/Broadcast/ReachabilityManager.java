package com.vibescom.kutanga.Broadcast;
...
public class ReachabilityManager extends BroadcastReceiver {
    ...
    public static synchronized ReachabilityManager reachabilityManager (){
        ...
        if(type== ConnectivityManager.TYPE_WIFI){
            ...
            switch(subtype) {
                ...
                case TelephonyManager.NETWORK_TYPE_HSDPA:
                    return true; // ~ news_detail-14 Mbps
                case TelephonyManager.NETWORK_TYPE_HSPA:
                    return true; // ~ 700-1700 kbps
                case TelephonyManager.NETWORK_TYPE_HSUPA:
                    return true; // ~ news_head-23 Mbps
                case TelephonyManager.NETWORK_TYPE_UMTS:
                    return true; // ~ 400-7000 kbps
                case TelephonyManager.NETWORK_TYPE_EHRPD: // API level 11
                    return true; // ~ news_head-news_detail Mbps
