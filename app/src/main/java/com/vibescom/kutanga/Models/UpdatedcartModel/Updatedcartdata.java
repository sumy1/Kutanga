package com.vibescom.kutanga.Models.UpdatedcartModel;
...
public class Updatedcartdata extends BaseModel implements Serializable {
  ...
  private String resturantsImgpath;
    ...
    public JSONObject getCartdataObject() {
        return cartdataObject;
    }

    public void setCartdataObject(JSONObject cartdataObject) {
        this.cartdataObject = cartdataObject;
    }

    private JSONObject cartdataObject;

  private CopyOnWriteArrayList<CartItemModel>cartItemModels;



   public Updatedcartdata(JSONObject jsonObject){
       ...
       if(jsonObject.has("cartData")){
           try {
               cartdataObject=jsonObject.getJSONObject("cartData");
           } catch (JSONException e) {
               e.printStackTrace();
           }
       }
