...
public class ResturantsproductModel {
    ...
    private CopyOnWriteArrayList<ProductImage>productImages;
    public CopyOnWriteArrayList<ProductImage> getProductImages() {
        return productImages;
    }

    public void setProductImages(CopyOnWriteArrayList<ProductImage> productImages) {
        this.productImages = productImages;
    }



    public ResturantsproductModel(JSONObject jsonObject){
        ...
        if(jsonObject.has(kproductImage)){
            try {
                this.productImages = handleProductImage(jsonObject.getJSONArray(kproductImage));
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
