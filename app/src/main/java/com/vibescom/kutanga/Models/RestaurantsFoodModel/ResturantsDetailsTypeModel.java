...
public class ResturantsDetailsTypeModel {
    ...
    public JSONObject getVendorJson() {
        return vendorJson;
    }

    public void setVendorJson(JSONObject vendorJson) {
        this.vendorJson = vendorJson;
    }

    private JSONObject vendorJson;





    public ResturantsDetailsTypeModel(JSONObject jsonObject){
        ...
        if(jsonObject.has(kVendor)){
            try {
                this.vendorJson=jsonObject.getJSONObject(kVendor);
