...
import static com.vibescom.kutanga.Constants.Constants.kVendorProduct;
...
public class SearchResturantsModel {
    ...
    public String getOrderBookingSttaus() {
        return orderBookingSttaus;
    }

    public void setOrderBookingSttaus(String orderBookingSttaus) {
        this.orderBookingSttaus = orderBookingSttaus;
    }

    private String orderBookingSttaus;


    public CopyOnWriteArrayList<ResturantsDishesproductModel> getResturantsproductModels() {
        return resturantsproductModels;
    }

    public void setResturantsproductModels(CopyOnWriteArrayList<ResturantsDishesproductModel> resturantsproductModels) {
        this.resturantsproductModels = resturantsproductModels;
    }

    private CopyOnWriteArrayList<ResturantsDishesproductModel> resturantsproductModels;



    public SearchResturantsModel(JSONObject jsonObject){
        ...
        this.orderBookingSttaus=getValue(jsonObject,kOrderBookingStatus,String.class);

        if(jsonObject.has(kVendorProduct)){
            try {
                this.resturantsproductModels = handleMarketPlace(jsonObject.getJSONArray(kVendorProduct));
    ...
    private CopyOnWriteArrayList<ResturantsDishesproductModel> handleMarketPlace(JSONArray jsonArray) throws JSONException {
        CopyOnWriteArrayList<ResturantsDishesproductModel> marketPlaces = new CopyOnWriteArrayList<>();
        for(int i=0;i<jsonArray.length();i++){
            marketPlaces.add(new ResturantsDishesproductModel(jsonArray.getJSONObject(i)));
        }
        return marketPlaces;
    }
}
