...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull PredictionHolder mPredictionHolder, final int i) {
        mPredictionHolder.txt_city_address.setText(mResultList.get(i).txt_city_address);
        mPredictionHolder.txt_city_name.setText(mResultList.get(i).txt_city_name);
    }
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private TextView txt_city_address, txt_city_name;
        private RelativeLayout mRow;

        PredictionHolder(View itemView) {
            super(itemView);
            txt_city_name = itemView.findViewById(R.id.txt_city_name);
            txt_city_address = itemView.findViewById(R.id.txt_city_address);
    ...
    public class PlaceAutocomplete {
        ...
        public CharSequence txt_city_address ;
        public CharSequence txt_city_name;
        PlaceAutocomplete(CharSequence placeId, CharSequence txt_city_name, CharSequence txt_city_address) {
            this.placeId = placeId;
            this.txt_city_name = txt_city_name;
            this.txt_city_address = txt_city_address;
        }

        @Override
        public String toString() {
            return txt_city_name.toString();
        }
    }
}
