...
public class RestautansTopPicForYouDetailsAdapter extends RecyclerView.Adapter<RestautansTopPicForYouDetailsAdapter.myViewHolder> {
    private Context context;
    //private CopyOnWriteArrayList<UserFacAca> mData;
    private onItemClickListener listener;
    Dialog dialog;

    public RestautansTopPicForYouDetailsAdapter(Context context) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layoutView = LayoutInflater.from(context).inflate(R.layout.row_view_restorants_home_toppicforyou_details, parent, false);
