...
public class CategoryPriceAdapter extends RecyclerView.Adapter<CategoryPriceAdapter.myViewHolder> {
    ...
    public CategoryPriceAdapter(Context context,CopyOnWriteArrayList<ProductPrice> productPrices,selectItemInterface listner) {
