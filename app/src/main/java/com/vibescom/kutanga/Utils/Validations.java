...
public class Validations {
   ...
   /* public static boolean isValidIFSC(String ifsc){
    ...
    public static boolean isValidCardNumber(String testString){

        return (testString.length()>=16 && testString.length()<=19);
    }
    public static boolean isValidCvv(String testString){
        return (testString.length()==3);
    }

    public static boolean isValidateExpiry(String testString){
        return  testString.matches("(?:0[1-9]|1[0-2])/[0-9]{2}");
    }
